 ...
 */
/* Bash, C, C#, C++, CSS, Diff, Go, HTML/XML, JSON, Java, JavaScript, Kotlin, Lua, Makefile, Markdwn, Objective-C, PHP, PHP Template, Perl, Plain text, Python, Python REPL, Ruby, Rust, SCSS, SQL, Shell Session, Swift, TOML/INI, TypeScript, Visual Basic .NET, WebAssembly, YAML, .properties, DOS Batch file, Dockerfile, GLSL, HTTP, Handlebars, Nginx config, Node REPL, PowerShell */
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})();hljs.registerLanguage("swift",e)})();/*! `makefile` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("ruby",e)})();/*! `rust` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("rust",e)})();/*! `powershell` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("powershell",e)})();/*! `javascript` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict"
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})();hljs.registerLanguage("node-repl",a)})();/*! `glsl` grammar compiled for Highlight.js 11.7.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.7.0 */
...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `php-template` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("go",e)})();/*! `dockerfile` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("dockerfile",e)})();/*! `markdown` grammar compiled for Highlight.js 11.7.0 */
...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `handlebars` grammar compiled for Highlight.js 11.7.0 */
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[N]}]}}})()
;hljs.registerLanguage("handlebars",e)})();/*! `wasm` grammar compiled for Highlight.js 11.7.0 */
